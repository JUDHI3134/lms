    ...
    <>
      <div className='flex flex-col-reverse md:flex-row gap-10 relative items-start justify-between md:px-36 px-8 pt-20 md:pt-30 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className=''>Course by <span className='text-blue-600 underline'>{courseData.educator.name}</span></p>
        ...
        <div className='max-w-[424px] z-10 shadow-lg rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            ...
            <button onClick={enrollCourse} className='mt-4 md:mt-6 w-full py-3 rounded bg-orange-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>
